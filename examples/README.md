...
- `registry_loader.zig` — `MemorySourceTree` plus filesystem `loadDir`,
  recursive imports, typed file option/import/dependency metadata and import-kind dependency index/option-dependency reflection lookup, import-chain reflection lookup/accessors/index, message/service/method registry lookup, and
...
- `dynamic_editions_features.zig` — dynamic protobuf editions features:
  ...
  delimited message encoding, relaxed UTF-8, reflection file/message/field/oneof/enum/enum-value/service/method/extension-range feature metadata and FeatureSet/FeatureSetDefaults accessors, cross-file extension owner-file feature defaults for binary/JSON/TextFormat/reflection paths, and closed enum preservation.
...
- `dynamic_messageset.zig` — dynamic proto2 MessageSet encode/decode,
  ...
  preservation.
- `descriptors_codegen.zig` — descriptor encode/decode, source-code info lookup/enumeration/accessors/path-span coordinate/index plus comment presence and detached-comment index,
  uninterpreted custom options, service/method options, descriptor sets, direct
  codegen, plugin request generation, and generated-code info annotation lookup/accessors/path index.
- `reflection_facade.zig` — reflection facade over registry descriptors and
  dynamic messages, including typed get/set/add/get-default/clear helpers, field-value record accessors/index and dynamic/default value tags/accessors,
  present-field listing/access/index, type-checked writes, typed repeated scalar access/index/replacement across all scalar families, repeated enum descriptor/name lookup, repeated field replacement/reordering/removal, all scalar families,
  typed singular/repeated message/group creation/access/mutation including typed repeated element access, field scalar/kind/declared-type/cpp-type-name/cpp-type/cardinality/optional-keyword/weak/lazy/debug-redact/ctype/jstype/retention/targets/index/wire-type/encoded-wire-type/direct-containing/containing/extendee/oneof/direct-owner/index metadata, lowercase/camelcase/JSON field-name lookup/output, maps, map-entry descriptor metadata, map key/value metadata, map size/key/value/entry enumeration/access/index, map key lookup, repeated/map enum-name lookup, JSON-name field lookup/output/explicitness, explicit/effective typed default/index metadata and default-value accessors plus enum default value/name lookup, field presence/packing/packed-override/reserved range/name lookup/enumeration/index/explicit-end/descriptor-aware accessors
  metadata, message/enum legacy-json-conflict metadata, feature-support lifecycle metadata/accessors/presence, ordered file/message/nested-type/enum/service descriptor enumeration/index lookup plus descriptor-named index aliases, file/message-local descriptor/value lookup/index, descriptor name/full-name/containing-file/containing-type/value-owner/direct field-type identity and placeholder metadata lookup, file metadata/import/dependency/import-kind dependency index/import-chain/symbol-containing-file lookup, enum descriptor/value registry lookup/direct-owner and enum-name writes, oneof field enumeration/index plus descriptor-direct oneof field access/index and oneof
  ...
  file-local service lookup, registry field/oneof/method lookup, service/method owner/type/direct-type/deprecation metadata, and extension descriptor lookup, dynamic merge/copy/clone, unknown-field query/mutation/number-run/index/payload access,
...
- `well_known_types.zig` — Timestamp, Duration, FieldMask emptiness/path presence/access/index, Empty JSON allocation helper,
  Struct emptiness/field presence/access/index/equality, Value equality/typed accessors, ListValue emptiness/presence/access/index/equality, scalar wrappers, bytes wrappers, and Any including
