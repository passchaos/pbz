...
- `reflection_facade.zig` — reflection facade over registry descriptors and
  ...
  present-field listing, type-checked writes, typed repeated scalar access/replacement across all scalar families, repeated field replacement/reordering/removal, all scalar families,
