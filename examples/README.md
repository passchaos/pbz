...
- `dynamic_messageset.zig` — dynamic proto2 MessageSet encode/decode,
  ...
  preservation.
- `descriptors_codegen.zig` — descriptor encode/decode, source-code info lookup/accessors,
...
- `proto2_extensions.zig` — proto2 extension parsing through TextFormat/JSON,
  ...
  bounds/verification/declaration metadata, reflection extension/range/declaration/full-name/extendee/scope lookup, descriptor
