...
- `dynamic_editions_features.zig` — dynamic protobuf editions features:
  ...
  delimited message encoding, relaxed UTF-8, reflection file/message/field/oneof/enum/enum-value/service/method/extension-range feature metadata, cross-file extension owner-file feature defaults for binary/JSON/TextFormat/reflection paths, and closed enum preservation.
