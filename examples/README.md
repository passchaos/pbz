...
- `reflection_facade.zig` — reflection facade over registry descriptors and
  ...
  file-local service lookup, registry method lookup, service/method owner/type/deprecation metadata, and extension descriptor lookup, dynamic merge/copy/clone, unknown-field query/mutation,
