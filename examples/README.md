...
- `proto2_extensions.zig` — proto2 extension parsing through TextFormat/JSON,
  ...
  bounds/verification/declaration metadata, reflection extension/all-extensions/range/declaration/full-name/extendee/scope/containing-type lookup/enumeration/index and lowercase/camelcase/printable name lookup, descriptor
