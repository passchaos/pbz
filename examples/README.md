...
- `registry_loader.zig` — `MemorySourceTree` plus filesystem `loadDir`,
  recursive imports, typed file option/import/dependency metadata and import-kind dependency index/option-dependency reflection lookup, import-chain reflection lookup/accessors, message/service/method registry lookup, and
