...
pub const proto_package = "demo.jsonnames";
pub const proto_syntax = "proto3";

pub const demo = struct {
    pub const jsonnames = struct {
        pub const JsonNames = struct {
            pub const display_name_number = 1;
            pub const legacy_count_number = 2;
            pub const same_name_number = 3;

            pub const display_name_field = struct {
                pub const number = 1;
                pub const name = "display_name";
                pub const json_name = "shownName";
            ...
            pub const legacy_count_field = struct {
                pub const number = 2;
                pub const name = "legacy_count";
                pub const json_name = "legacy-count";
                pub const cardinality = "optional";
            ...
            pub const same_name_field = struct {
                pub const number = 3;
                pub const name = "same_name";
                pub const json_name = "same_name";
                pub const cardinality = "optional";
                pub const kind = "string";
                pub const type_name = "string";
                pub const zig_type = "[]const u8";
            ...
            pub fn cloneOwned(self: @This(), allocator: std.mem.Allocator) !@This() {
                ...
                out.display_name = try owned_allocator.dupe(u8, self.display_name);
                out.legacy_count = self.legacy_count;
                out.same_name = try owned_allocator.dupe(u8, self.same_name);
            ...
            pub fn display_nameFieldView(bytes: []const u8) !?[]const u8 {
                return try pbz.wire.bytesFieldView(bytes, 1);
            }

            pub fn display_nameFieldSlices(header: *[20]u8, value: []const u8) !pbz.wire.BorrowedFieldSlices {
                return pbz.wire.lengthDelimitedFieldSlicesAssumeValid(header, 1, value);
            }

            pub fn display_nameStringView(bytes: []const u8) !?[]const u8 {
                return try display_nameFieldView(bytes);
            }

            pub fn display_nameStringSlices(header: *[20]u8, value: []const u8) !pbz.wire.BorrowedFieldSlices {
                return try display_nameFieldSlices(header, value);
            }

            pub fn same_nameFieldView(bytes: []const u8) !?[]const u8 {
                return try pbz.wire.bytesFieldView(bytes, 3);
            }

            pub fn same_nameFieldSlices(header: *[20]u8, value: []const u8) !pbz.wire.BorrowedFieldSlices {
                return pbz.wire.lengthDelimitedFieldSlicesAssumeValid(header, 3, value);
            }

            pub fn same_nameStringView(bytes: []const u8) !?[]const u8 {
                return try same_nameFieldView(bytes);
            }

            pub fn same_nameStringSlices(header: *[20]u8, value: []const u8) !pbz.wire.BorrowedFieldSlices {
                return try same_nameFieldSlices(header, value);
            }
            ...
            pub fn mergeFrom(self: *@This(), allocator: std.mem.Allocator, other: @This()) !void {
                if (other.display_name.len != 0) self.display_name = other.display_name;
                if (other.legacy_count != 0) self.legacy_count = other.legacy_count;
                if (other.same_name.len != 0) self.same_name = other.same_name;
                try pbz.wire.appendRawFieldsClone(allocator, &self._unknown_fields, other._unknown_fields);
            }

            pub fn encodedSize(self: @This()) usize {
                var size: usize = 0;
                if (self.display_name.len != 0) size += 1 + pbz.wire.encodedVarintSize(self.display_name.len) + self.display_name.len;
                if (self.legacy_count != 0) size += 1 + pbz.wire.encodedVarintSize(@as(u64, @bitCast(@as(i64, self.legacy_count))));
                if (self.same_name.len != 0) size += 1 + pbz.wire.encodedVarintSize(self.same_name.len) + self.same_name.len;
                for (self._unknown_fields) |raw| size += raw.len;
                return size;
            }

            pub fn writeTo(self: @This(), w: *pbz.Writer) !void {
                if (self.display_name.len != 0) { if (!pbz.validateUtf8(self.display_name)) return error.InvalidUtf8; try w.writeString(1, self.display_name); }
                if (self.legacy_count != 0) try w.writeInt32(2, self.legacy_count);
                if (self.same_name.len != 0) { if (!pbz.validateUtf8(self.same_name)) return error.InvalidUtf8; try w.writeString(3, self.same_name); }
                for (self._unknown_fields) |raw| try w.appendSlice(raw);
            }

            pub fn writeToAssumeCapacity(self: @This(), w: *pbz.Writer) !void {
                if (self.display_name.len != 0) { if (!pbz.validateUtf8(self.display_name)) return error.InvalidUtf8; w.writeStringAssumeCapacity(1, self.display_name); }
                if (self.legacy_count != 0) w.writeInt32AssumeCapacity(2, self.legacy_count);
                if (self.same_name.len != 0) { if (!pbz.validateUtf8(self.same_name)) return error.InvalidUtf8; w.writeStringAssumeCapacity(3, self.same_name); }
            ...
            pub fn encodeIntoAssumeCapacity(self: @This(), buffer: []u8) ![]u8 {
                var index: usize = 0;
                if (self.display_name.len != 0) { if (!pbz.validateUtf8(self.display_name)) return error.InvalidUtf8; buffer[index] = 10; index += 1; pbz.wire.writeVarintToSlice(buffer, &index, self.display_name.len); @memcpy(buffer[index..][0..self.display_name.len], self.display_name); index += self.display_name.len; }
                if (self.legacy_count != 0) { buffer[index] = 16; index += 1; pbz.wire.writeDirectScalarVarintToSlice(buffer, &index, @as(u64, @bitCast(@as(i64, self.legacy_count)))); }
                if (self.same_name.len != 0) { if (!pbz.validateUtf8(self.same_name)) return error.InvalidUtf8; buffer[index] = 26; index += 1; pbz.wire.writeVarintToSlice(buffer, &index, self.same_name.len); @memcpy(buffer[index..][0..self.same_name.len], self.same_name); index += self.same_name.len; }
            ...
            pub fn encodeIntoAssumeCapacityTrustedUtf8(self: @This(), buffer: []u8) ![]u8 {
                var index: usize = 0;
                if (self.display_name.len != 0) { buffer[index] = 10; index += 1; pbz.wire.writeVarintToSlice(buffer, &index, self.display_name.len); @memcpy(buffer[index..][0..self.display_name.len], self.display_name); index += self.display_name.len; }
                if (self.legacy_count != 0) { buffer[index] = 16; index += 1; pbz.wire.writeDirectScalarVarintToSlice(buffer, &index, @as(u64, @bitCast(@as(i64, self.legacy_count)))); }
                if (self.same_name.len != 0) { buffer[index] = 26; index += 1; pbz.wire.writeVarintToSlice(buffer, &index, self.same_name.len); @memcpy(buffer[index..][0..self.same_name.len], self.same_name); index += self.same_name.len; }
                for (self._unknown_fields) |raw| { @memcpy(buffer[index..][0..raw.len], raw); index += raw.len; }
                return buffer[0..index];
            }
            ...
            pub fn decodeFromReader(allocator: std.mem.Allocator, r: *pbz.Reader) !@This() {
                ...
                while (!r.eof()) {
                    ...
                    switch (raw_tag) {
                        10 => { self.display_name = try r.readBytes(); if (!pbz.validateUtf8(self.display_name)) return error.InvalidUtf8; },
                        16 => { self.legacy_count = try r.readInt32(); },
                        26 => { self.same_name = try r.readBytes(); if (!pbz.validateUtf8(self.same_name)) return error.InvalidUtf8; },
            ...
            pub fn jsonStringifyWithOptions(self: @This(), allocator: std.mem.Allocator, writer: *std.Io.Writer, options: @This().JsonStringifyOptions) !void {
                ...
                try writer.writeAll("{");
                var first = true;
                if (self.display_name.len != 0 or options.always_print_primitive_fields) {
                    try writer.writeAll(if (options.preserve_proto_field_names) (if (first) "\"display_name\":" else ",\"display_name\":") else (if (first) "\"shownName\":" else ",\"shownName\":")); first = false;
                    const value = self.display_name;
                    try @This().jsonWriteString(writer, value);
                }
                if (self.legacy_count != 0 or options.always_print_primitive_fields) {
                    try writer.writeAll(if (options.preserve_proto_field_names) (if (first) "\"legacy_count\":" else ",\"legacy_count\":") else (if (first) "\"legacy-count\":" else ",\"legacy-count\":")); first = false;
                    const value = self.legacy_count;
                    try writer.print("{d}", .{value});
                }
                if (self.same_name.len != 0 or options.always_print_primitive_fields) {
                    try writer.writeAll(if (first) "\"same_name\":" else ",\"same_name\":"); first = false;
                    const value = self.same_name;
                    try @This().jsonWriteString(writer, value);
                }
                try writer.writeAll("}");
            }
            ...
            fn jsonFillFromValue(self: *@This(), allocator: std.mem.Allocator, arena_allocator: std.mem.Allocator, json_value: std.json.Value, options: @This().JsonParseOptions) !void {
                ...
                while (it.next()) |entry| {
                    ...
                    if (value == .null) {
                        if (std.mem.eql(u8, key, "display_name") or std.mem.eql(u8, key, "shownName")) {
                            self.display_name = "";
                            continue;
                        }
                        if (std.mem.eql(u8, key, "legacy_count") or std.mem.eql(u8, key, "legacy-count")) {
                            self.legacy_count = 0;
                            continue;
                        }
                        if (std.mem.eql(u8, key, "same_name")) {
                            self.same_name = "";
                            continue;
                        }
                    ...
                    if (std.mem.eql(u8, key, "display_name") or std.mem.eql(u8, key, "shownName")) {
                        self.display_name = try @This().jsonString(value);
                        continue;
                    }
                    if (std.mem.eql(u8, key, "legacy_count") or std.mem.eql(u8, key, "legacy-count")) {
                        self.legacy_count = try @This().jsonInt(i32, value);
                        continue;
                    }
                    if (std.mem.eql(u8, key, "same_name")) {
                        self.same_name = try @This().jsonString(value);
                        continue;
                    }
                    if (options.ignore_unknown_fields) continue;
                    return error.UnknownField;
...
fn jsonWriteString(writer: *std.Io.Writer, value: []const u8) !void {
    ...
    try std.json.Stringify.value(value, .{}, writer);
            ...
            pub fn formatTextWithOptions(self: @This(), allocator: std.mem.Allocator, writer: *std.Io.Writer, options: @This().TextFormatOptions) !void {
                _ = allocator;
                _ = options;
                if (self.display_name.len != 0) { try writer.writeAll("display_name: "); const value = self.display_name; if (!pbz.validateUtf8(value)) return error.InvalidUtf8; try @This().textWriteQuotedBytes(value, writer); try writer.writeByte('\n'); }
                if (self.legacy_count != 0) { try writer.writeAll("legacy_count: "); const value = self.legacy_count; try writer.print("{d}", .{value}); try writer.writeByte('\n'); }
                if (self.same_name.len != 0) { try writer.writeAll("same_name: "); const value = self.same_name; if (!pbz.validateUtf8(value)) return error.InvalidUtf8; try @This().textWriteQuotedBytes(value, writer); try writer.writeByte('\n'); }
            ...
            pub fn parseTextWithOptions(allocator: std.mem.Allocator, text: []const u8, options: @This().TextParseOptions) !@This() {
                ...
                while (lines.next()) |raw_line| {
                    const line = @This().textCleanLine(raw_line, text_has_comments);
                    if (line.len == 0) continue;
                    if (@This().textFieldValue(line, "display_name") orelse @This().textFieldValue(line, "shownName")) |raw_value| {
                        self.display_name = blk: { const decoded = try @This().textUnquote(try self._pbzOwnedAllocator(allocator), raw_value); if (!pbz.validateUtf8(decoded)) return error.InvalidUtf8; break :blk decoded; };
                        continue;
                    }
                    if (@This().textFieldValue(line, "legacy_count") orelse @This().textFieldValue(line, "legacy-count")) |raw_value| {
                        self.legacy_count = try @This().textInt(i32, raw_value);
                        continue;
                    }
                    if (@This().textFieldValue(line, "same_name")) |raw_value| {
                        self.same_name = blk: { const decoded = try @This().textUnquote(try self._pbzOwnedAllocator(allocator), raw_value); if (!pbz.validateUtf8(decoded)) return error.InvalidUtf8; break :blk decoded; };
                        continue;
                    }
