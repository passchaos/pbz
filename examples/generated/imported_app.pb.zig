...
pub const imports = struct {
    pub const @"imported_common.proto" = @import("imported_common.pb.zig");
    pub const @"imported_common.proto_path" = "imported_common.proto";
    pub const @"imported_common.proto_kind" = "normal";
};
