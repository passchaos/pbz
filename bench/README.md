...
- direct scalar wrapper JSON stringify/parse for `DoubleValue`, `FloatValue`,
  ...
  non-empty/escape-input parse/empty `StringValue`, and padded-standard/base64url/unpadded-base64 parse/empty `BytesValue`
