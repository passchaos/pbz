...
- direct `google.protobuf.Empty`, non-empty/escaped-input parse/empty `Struct`, object/escaped-object parse/list/escaped-list/string-scalar/escaped-string-scalar `Value` (including default-like scalar and empty object/list kinds), and escaped/non-empty/empty `ListValue` JSON stringify/parse
