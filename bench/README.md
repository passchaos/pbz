...
- direct scalar wrapper JSON stringify/parse for `DoubleValue`, `FloatValue`,
  ...
  non-empty/escape-input parse/empty `StringValue`, and base64/base64url/unpadded-base64 parse/empty `BytesValue`
