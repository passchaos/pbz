...
int main() {
  ...
  const std::string proto_name_json =
      R"({"big_delta":-321,"signed_fixed":-123,"signed_big_fixed":-456})";
  {
    demo::ScalarMix decoded;
    if (!google::protobuf::util::JsonStringToMessage(proto_name_json, &decoded)
             .ok())
      std::abort();
    if (decoded.big_delta() != -321 || decoded.signed_fixed() != -123 ||
        decoded.signed_big_fixed() != -456)
      std::abort();
  }
  ...
  {
    demo::ScalarMix decoded;
    if (!google::protobuf::util::JsonStringToMessage(int_exponent_json,
                                                     &decoded)
             .ok())
      std::abort();
  ...
  const std::string any_plus_duration_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Duration","value":"+1.500s"})";
  const std::string short_fraction_duration_json = R"("1.5s")";
  const std::string any_short_fraction_duration_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Duration","value":"1.5s"})";
  ...
  google::protobuf::Duration fractional_negative_duration;
  fractional_negative_duration.set_nanos(-250000000);
  google::protobuf::Any any_fractional_negative_duration_wkt;
  any_fractional_negative_duration_wkt.PackFrom(fractional_negative_duration);
  const std::string any_fractional_negative_duration_wkt_json =
  ...
  google::protobuf::Duration min_duration;
  min_duration.set_seconds(-315576000000LL);
  google::protobuf::Any any_min_duration_wkt;
  any_min_duration_wkt.PackFrom(min_duration);
  const std::string any_min_duration_wkt_json =
      JsonStringFor(any_min_duration_wkt);
  const std::string min_duration_json = JsonStringFor(min_duration);
  google::protobuf::Duration zero_duration;
  google::protobuf::Any any_zero_duration_wkt;
  any_zero_duration_wkt.PackFrom(zero_duration);
  const std::string any_zero_duration_wkt_json =
      JsonStringFor(any_zero_duration_wkt);
  const std::string zero_duration_json = JsonStringFor(zero_duration);
  ...
  google::protobuf::Timestamp max_timestamp;
  max_timestamp.set_seconds(253402300799LL);
  max_timestamp.set_nanos(999999999);
  const std::string max_timestamp_json = JsonStringFor(max_timestamp);
  google::protobuf::Any any_max_timestamp_wkt;
  ...
  const std::string any_struct_number_exponent_wkt_json =
  ...
  const std::string any_value_number_exponent_wkt_json =
  ...
  const std::string list_value_surrogate_json = R"(["\ud83d\ude00"])";
  ...
  const std::string list_kind_value_surrogate_json = list_value_surrogate_json;
  ...
  const std::string any_list_kind_value_surrogate_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Value","value":["\ud83d\ude00"]})";
  ...
  const std::string empty_struct_kind_value_json =
      JsonStringFor(empty_struct_kind_value);
  google::protobuf::Any any_empty_struct_kind_value_wkt;
  any_empty_struct_kind_value_wkt.PackFrom(empty_struct_kind_value);
  const std::string any_empty_struct_kind_value_wkt_json =
      JsonStringFor(any_empty_struct_kind_value_wkt);
  google::protobuf::ListValue empty_list_value;
  const std::string empty_list_value_json = JsonStringFor(empty_list_value);
  google::protobuf::Value empty_list_kind_value;
  empty_list_kind_value.mutable_list_value()->CopyFrom(empty_list_value);
  const std::string empty_list_kind_value_json =
      JsonStringFor(empty_list_kind_value);
  google::protobuf::Any any_empty_list_kind_value_wkt;
  any_empty_list_kind_value_wkt.PackFrom(empty_list_kind_value);
  const std::string any_empty_list_kind_value_wkt_json =
      JsonStringFor(any_empty_list_kind_value_wkt);
  ...
  const std::string double_value_exponent_json = R"(3.25e0)";
  ...
  const std::string any_double_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.DoubleValue","value":3.25e0})";
  ...
  google::protobuf::Any any_double_value_nan_wkt;
  ...
  google::protobuf::DoubleValue double_value_neg_inf;
  double_value_neg_inf.set_value(-std::numeric_limits<double>::infinity());
  const std::string double_value_neg_inf_json =
      JsonStringFor(double_value_neg_inf);
  google::protobuf::Any any_double_value_neg_inf_wkt;
  any_double_value_neg_inf_wkt.PackFrom(double_value_neg_inf);
  const std::string any_double_value_neg_inf_wkt_json =
      JsonStringFor(any_double_value_neg_inf_wkt);
  ...
  const std::string float_value_exponent_json = R"(1.5e0)";
  ...
  const std::string any_float_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.FloatValue","value":1.5e0})";
  ...
  google::protobuf::Any any_float_value_nan_wkt;
  ...
  google::protobuf::FloatValue float_value_neg_inf;
  float_value_neg_inf.set_value(-std::numeric_limits<float>::infinity());
  const std::string float_value_neg_inf_json =
      JsonStringFor(float_value_neg_inf);
  google::protobuf::Any any_float_value_neg_inf_wkt;
  any_float_value_neg_inf_wkt.PackFrom(float_value_neg_inf);
  const std::string any_float_value_neg_inf_wkt_json =
      JsonStringFor(any_float_value_neg_inf_wkt);
  ...
  const std::string int64_value_exponent_json = R"(1.2345e4)";
  ...
  const std::string any_int64_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Int64Value","value":1.2345e4})";
  ...
  const std::string uint64_value_exponent_json = R"(1.2345e4)";
  ...
  const std::string any_uint64_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.UInt64Value","value":1.2345e4})";
  ...
  const std::string int32_value_string_json = R"("12345")";
  const std::string int32_value_exponent_json = R"(1.2345e4)";
  ...
  const std::string any_int32_value_string_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Int32Value","value":"12345"})";
  const std::string any_int32_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.Int32Value","value":1.2345e4})";
  ...
  const std::string uint32_value_string_json = R"("12345")";
  const std::string uint32_value_exponent_json = R"(1.2345e4)";
  ...
  const std::string any_uint32_value_string_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.UInt32Value","value":"12345"})";
  const std::string any_uint32_value_exponent_wkt_json =
      R"({"@type":"type.googleapis.com/google.protobuf.UInt32Value","value":1.2345e4})";
  ...
  std::cout << "enum name json payload size: " << enum_name_json.size()
            << "\n";
  std::cout << "proto name json payload size: " << proto_name_json.size()
            << "\n";
  ...
  std::cout << "max timestamp json payload size: "
  ...
  std::cout << "short fraction duration json payload size: "
            << short_fraction_duration_json.size() << "\n";
  ...
  std::cout << "max duration json payload size: " << max_duration_json.size()
            << "\n";
  std::cout << "min duration json payload size: " << min_duration_json.size()
            << "\n";
  std::cout << "zero duration json payload size: " << zero_duration_json.size()
            << "\n";
  ...
  std::cout << "any ShortFractionDuration WKT json payload size: "
            << any_short_fraction_duration_wkt_json.size() << "\n";
  ...
  std::cout << "any MinDuration WKT json payload size: "
  ...
  std::cout << "struct number exponent json payload size: "
  ...
  std::cout << "value number exponent json payload size: "
  ...
  std::cout << "any Struct NumberExponent WKT json payload size: "
  ...
  std::cout << "any Value NumberExponent WKT json payload size: "
  ...
  std::cout << "list-kind value surrogate json payload size: "
            << list_kind_value_surrogate_json.size() << "\n";
  std::cout << "list value surrogate json payload size: "
            << list_value_surrogate_json.size() << "\n";
  ...
  std::cout << "any ListKindValue Surrogate WKT json payload size: "
            << any_list_kind_value_surrogate_wkt_json.size() << "\n";
  ...
  std::cout << "any EmptyStructKindValue WKT json payload size: "
            << any_empty_struct_kind_value_wkt_json.size() << "\n";
  std::cout << "empty list-kind value json payload size: "
            << empty_list_kind_value_json.size() << "\n";
  std::cout << "any EmptyListKindValue WKT json payload size: "
            << any_empty_list_kind_value_wkt_json.size() << "\n";
  ...
  std::cout << "double value exponent json payload size: "
            << double_value_exponent_json.size() << "\n";
  ...
  std::cout << "any DoubleValue Exponent WKT json payload size: "
            << any_double_value_exponent_wkt_json.size() << "\n";
  ...
  std::cout << "double value NegativeInfinity json payload size: "
            << double_value_neg_inf_json.size() << "\n";
  std::cout << "any DoubleValue NegativeInfinity WKT json payload size: "
  ...
  std::cout << "float value exponent json payload size: "
            << float_value_exponent_json.size() << "\n";
  ...
  std::cout << "any FloatValue Exponent WKT json payload size: "
            << any_float_value_exponent_wkt_json.size() << "\n";
  ...
  std::cout << "float value NegativeInfinity json payload size: "
            << float_value_neg_inf_json.size() << "\n";
  std::cout << "any FloatValue NegativeInfinity WKT json payload size: "
  ...
  std::cout << "int64 value exponent json payload size: "
            << int64_value_exponent_json.size() << "\n";
  ...
  std::cout << "any Int64Value Exponent WKT json payload size: "
            << any_int64_value_exponent_wkt_json.size() << "\n";
  ...
  std::cout << "uint64 value exponent json payload size: "
            << uint64_value_exponent_json.size() << "\n";
  ...
  std::cout << "any UInt64Value Exponent WKT json payload size: "
            << any_uint64_value_exponent_wkt_json.size() << "\n";
  ...
  std::cout << "int32 value json payload size: " << int32_value_json.size()
            << "\n";
  std::cout << "int32 value string json payload size: "
            << int32_value_string_json.size() << "\n";
  std::cout << "int32 value exponent json payload size: "
            << int32_value_exponent_json.size() << "\n";
  std::cout << "any Int32Value WKT json payload size: "
            << any_int32_value_wkt_json.size() << "\n";
  std::cout << "any Int32Value String WKT json payload size: "
            << any_int32_value_string_wkt_json.size() << "\n";
  std::cout << "any Int32Value Exponent WKT json payload size: "
            << any_int32_value_exponent_wkt_json.size() << "\n";
  ...
  std::cout << "uint32 value json payload size: " << uint32_value_json.size()
            << "\n";
  std::cout << "uint32 value string json payload size: "
            << uint32_value_string_json.size() << "\n";
  std::cout << "uint32 value exponent json payload size: "
            << uint32_value_exponent_json.size() << "\n";
  std::cout << "any UInt32Value WKT json payload size: "
            << any_uint32_value_wkt_json.size() << "\n";
  std::cout << "any UInt32Value String WKT json payload size: "
            << any_uint32_value_string_wkt_json.size() << "\n";
  std::cout << "any UInt32Value Exponent WKT json payload size: "
            << any_uint32_value_exponent_wkt_json.size() << "\n";
  ...
  auto proto_name_json_parse =
      RunTimed("c++ protobuf ProtoName JSON parse", kIterations,
               proto_name_json.size(), [&]() {
                 demo::ScalarMix decoded;
                 if (!google::protobuf::util::JsonStringToMessage(
                          proto_name_json, &decoded)
                          .ok())
                   std::abort();
                 asm volatile("" : : "g"(&decoded) : "memory");
               });
  proto_name_json_parse.Print();

  auto int_exponent_json_parse =
      RunTimed("c++ protobuf IntExponent JSON parse", kIterations,
               int_exponent_json.size(), [&]() {
                 demo::ScalarMix decoded;
                 if (!google::protobuf::util::JsonStringToMessage(
                          int_exponent_json, &decoded)
                          .ok())
                   std::abort();
                 asm volatile("" : : "g"(&decoded) : "memory");
               });
  ...
  {
    const std::string parse_name =
        "c++ protobuf Any ShortFractionDuration WKT JSON parse";
    auto parse =
        RunTimed(parse_name.c_str(), kIterations,
                 any_short_fraction_duration_wkt_json.size(), [&]() {
                   google::protobuf::Any decoded;
                   if (!google::protobuf::util::JsonStringToMessage(
                            any_short_fraction_duration_wkt_json, &decoded)
                            .ok())
                     std::abort();
                   asm volatile("" : : "g"(&decoded) : "memory");
                 });
  ...
  RunWktJsonBenchPair("Any MinDuration WKT", any_min_duration_wkt,
                      any_min_duration_wkt_json, kIterations);
  RunWktJsonBenchPair("Any ZeroDuration WKT", any_zero_duration_wkt,
  ...
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any ListKindValue Surrogate WKT",
      any_list_kind_value_surrogate_wkt_json, kIterations);
  ...
  RunWktJsonBenchPair("Any EmptyListKindValue WKT",
                      any_empty_list_kind_value_wkt,
                      any_empty_list_kind_value_wkt_json, kIterations);
  ...
  {
    const std::string parse_name =
        "c++ protobuf ShortFractionDuration JSON parse";
    auto parse =
        RunTimed(parse_name.c_str(), kIterations,
                 short_fraction_duration_json.size(), [&]() {
                   google::protobuf::Duration decoded;
                   if (!google::protobuf::util::JsonStringToMessage(
                            short_fraction_duration_json, &decoded)
                            .ok())
                     std::abort();
                   asm volatile("" : : "g"(&decoded) : "memory");
                 });
  ...
  RunWktJsonBenchPair("MaxDuration", max_duration, max_duration_json,
                      kIterations);
  RunWktJsonBenchPair("MinDuration", min_duration, min_duration_json,
                      kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Value>(
      "ListKindValue Surrogate", list_kind_value_surrogate_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::ListValue>(
      "ListValue Surrogate", list_value_surrogate_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::DoubleValue>(
      "DoubleValue Exponent", double_value_exponent_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Any>(
      ...
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any DoubleValue Exponent WKT", any_double_value_exponent_wkt_json,
      kIterations);
  ...
  RunWktJsonBenchPair("Any DoubleValue Infinity WKT",
                      ...
                      kIterations);
  RunWktJsonBenchPair("DoubleValue NegativeInfinity", double_value_neg_inf,
                      double_value_neg_inf_json, kIterations);
  RunWktJsonBenchPair("Any DoubleValue NegativeInfinity WKT",
  ...
  RunWktJsonParseOnly<google::protobuf::FloatValue>(
      "FloatValue Exponent", float_value_exponent_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Any>(
      ...
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any FloatValue Exponent WKT", any_float_value_exponent_wkt_json,
      kIterations);
  ...
  RunWktJsonBenchPair("FloatValue NegativeInfinity", float_value_neg_inf,
                      float_value_neg_inf_json, kIterations);
  RunWktJsonBenchPair("Any FloatValue NegativeInfinity WKT",
  ...
  RunWktJsonParseOnly<google::protobuf::Int64Value>(
      "Int64Value Exponent", int64_value_exponent_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Any>(
      ...
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any Int64Value Exponent WKT", any_int64_value_exponent_wkt_json,
      kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::UInt64Value>(
      "UInt64Value Exponent", uint64_value_exponent_json, kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Any>(
      ...
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any UInt64Value Exponent WKT", any_uint64_value_exponent_wkt_json,
      kIterations);
  ...
  RunWktJsonParseOnly<google::protobuf::Int32Value>(
      "Int32Value String", int32_value_string_json, kIterations);
  RunWktJsonParseOnly<google::protobuf::Int32Value>(
      "Int32Value Exponent", int32_value_exponent_json, kIterations);
  RunWktJsonBenchPair("Any Int32Value WKT", any_int32_value_wkt,
                      any_int32_value_wkt_json, kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any Int32Value String WKT", any_int32_value_string_wkt_json,
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any Int32Value Exponent WKT", any_int32_value_exponent_wkt_json,
      kIterations);
  ...
  RunWktJsonBenchPair("UInt32Value", uint32_value, uint32_value_json,
                      kIterations);
  RunWktJsonParseOnly<google::protobuf::UInt32Value>(
      "UInt32Value String", uint32_value_string_json, kIterations);
  RunWktJsonParseOnly<google::protobuf::UInt32Value>(
      "UInt32Value Exponent", uint32_value_exponent_json, kIterations);
  RunWktJsonBenchPair("Any UInt32Value WKT", any_uint32_value_wkt,
                      any_uint32_value_wkt_json, kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any UInt32Value String WKT", any_uint32_value_string_wkt_json,
      kIterations);
  RunWktJsonParseOnly<google::protobuf::Any>(
      "Any UInt32Value Exponent WKT", any_uint32_value_exponent_wkt_json,
      kIterations);
