...
pub fn main() !void {
    ...
    std.debug.print("payload sizes generated JSON edge cases: null_fields_json={d} open_enum_json={d} enum_name_json={d} int_exponent_json={d}\n", .{ GeneratedNullFieldsJson.len, GeneratedOpenEnumJson.len, GeneratedEnumNameJson.len, GeneratedIntExponentJson.len });
