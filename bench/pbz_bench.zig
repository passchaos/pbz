...
pub fn main() !void {
    ...
    std.debug.print("payload sizes direct object/value WKTs: empty_json={d} struct_json={d} empty_struct_json={d} value_json={d} null_value_json={d} string_scalar_value_json={d} number_value_json={d} bool_scalar_value_json={d} list_kind_value_json={d} list_value_json={d} empty_list_value_json={d}\n", .{ empty_json.len, struct_json.len, empty_struct_json.len, value_json.len, null_value_json.len, string_scalar_value_json.len, number_value_json.len, bool_scalar_value_json.len, list_kind_value_json.len, list_value_json.len, empty_list_value_json.len });
