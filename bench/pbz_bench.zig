...
pub fn main() !void {
    ...
    std.debug.print("payload sizes generated JSON edge cases: null_fields_json={d} open_enum_json={d} enum_name_json={d} proto_name_parse_json={d} proto_name_stringify_json={d} always_print_stringify_json={d} int_exponent_json={d}\n", .{ GeneratedNullFieldsJson.len, GeneratedOpenEnumJson.len, GeneratedEnumNameJson.len, GeneratedProtoNameJson.len, generated_proto_name_json.len, generated_always_print_json.len, GeneratedIntExponentJson.len });
