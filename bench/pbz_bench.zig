...
pub fn main() !void {
    ...
    std.debug.print("payload sizes direct text/bool WKT wrappers: bool_value_json={d} false_bool_value_json={d} string_value_json={d} string_value_escape_json={d} empty_string_value_json={d} bytes_value_json={d} bytes_value_url_json={d} bytes_value_unpadded_json={d} empty_bytes_value_json={d} text={d}\n", .{ bool_value_json.len, false_bool_value_json.len, string_value_json.len, StringValueEscapeJson.len, empty_string_value_json.len, bytes_value_json.len, BytesValueUrlJson.len, BytesValueUnpaddedJson.len, empty_bytes_value_json.len, generated_text.len });
    ...
    std.debug.print("payload sizes Any WKT text/bool wrappers: any_bool_value_wkt_json={d} any_false_bool_value_wkt_json={d} any_string_value_wkt_json={d} any_empty_string_value_wkt_json={d} any_bytes_value_wkt_json={d} any_bytes_value_unpadded_wkt_json={d} any_empty_bytes_value_wkt_json={d}\n", .{ any_bool_value_wkt_json.len, any_false_bool_value_wkt_json.len, any_string_value_wkt_json.len, any_empty_string_value_wkt_json.len, any_bytes_value_wkt_json.len, AnyBytesValueUnpaddedWktJson.len, any_empty_bytes_value_wkt_json.len });
