...
WORKLOADS: tuple[Workload, ...] = (
    ...
    Workload(
        ...
        ("generated TextBytes JSON stringify",),
        {
            "c++ protobuf": ("c++ protobuf TextBytes JSON stringify",),
            "go protobuf": ("go protobuf TextBytes JSON stringify",),
        },
    ),
    Workload(
        "TextBytes JSON parse",
        ("generated TextBytes JSON parse",),
        {
            "c++ protobuf": ("c++ protobuf TextBytes JSON parse",),
            "go protobuf": ("go protobuf TextBytes JSON parse",),
        },
    ),
    Workload(
        "largebytes encode",
    ...
    Workload(
        "Complex ProtoName JSON stringify",
        ("generated Complex ProtoName JSON stringify",),
        {
            "c++ protobuf": ("c++ protobuf Complex ProtoName JSON stringify",),
            "go protobuf": ("go protobuf Complex ProtoName JSON stringify",),
        },
    ),
    Workload(
        "Complex ProtoName JSON parse",
        ("generated Complex ProtoName JSON parse",),
        {
            "c++ protobuf": ("c++ protobuf Complex ProtoName JSON parse",),
            "go protobuf": ("go protobuf Complex ProtoName JSON parse",),
        },
    ),
    Workload(
    ...
    Workload(
        "StringNumber JSON parse",
        ("generated StringNumber JSON parse",),
        {
            "c++ protobuf": ("c++ protobuf StringNumber JSON parse",),
            "go protobuf": ("go protobuf StringNumber JSON parse",),
        },
    ),
...
def self_test() -> None:
    ...
    sample_lines = [
        ...
        benchmark_line("generated TextBytes JSON stringify", 160, 110.0),
        benchmark_line("c++ protobuf TextBytes JSON stringify", 160, 850.0),
        benchmark_line("go protobuf TextBytes JSON stringify", 160, 600.0),
        ...
        benchmark_line("generated Complex ProtoName JSON stringify", 300, 150.0),
        benchmark_line("c++ protobuf Complex ProtoName JSON stringify", 300, 1200.0),
        benchmark_line("go protobuf Complex ProtoName JSON stringify", 300, 850.0),
        benchmark_line("generated Complex ProtoName JSON parse", 300, 250.0),
        benchmark_line("c++ protobuf Complex ProtoName JSON parse", 300, 1400.0),
        benchmark_line("go protobuf Complex ProtoName JSON parse", 300, 900.0),
        ...
        benchmark_line("generated StringNumber JSON parse", 190, 95.0),
        benchmark_line("c++ protobuf StringNumber JSON parse", 190, 520.0),
        benchmark_line("go protobuf StringNumber JSON parse", 190, 320.0),
    ]
