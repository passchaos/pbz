...
- `examples/reflection_facade.zig` covers the public reflection facade over
  ...
  message/enum legacy-json-conflict metadata, feature-support lifecycle metadata/accessors/presence, ordered file/message/nested-type/enum/service descriptor enumeration/index lookup plus descriptor-named index aliases, file/message-local descriptor/value lookup/index, descriptor name/full-name/containing-type/value-owner/direct field-type identity and placeholder metadata lookup,
