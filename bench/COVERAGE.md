...
- `examples/reflection_facade.zig` covers the public reflection facade over
  ...
  file metadata/import-chain lookup, enum descriptor/value registry lookup and enum-name writes, oneof field enumeration plus descriptor-direct oneof field access and oneof
