...
- `examples/proto2_extensions.zig` covers proto2 extension parsing, extension
  ...
  required-field validation, reflection extension/range/declaration/full-name/extendee/scope lookup/enumeration/index lookup, extension-range bounds/verification/declaration metadata and range/declaration enumeration, descriptor round-trips,
