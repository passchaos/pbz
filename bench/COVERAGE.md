...
- `examples/dynamic_editions_features.zig` covers dynamic protobuf editions
  ...
  relaxed UTF-8 strings, reflection feature metadata, closed enum unknown preservation, and TextFormat
  round-trip.
...
- `examples/reflection_facade.zig` covers the public reflection facade over
  ...
  type-checked writes, typed repeated scalar access/replacement across all scalar families, repeated enum descriptor/name lookup, repeated field replacement/reordering/removal, typed singular/repeated message/group creation/access/mutation including typed repeated element access, field type/extendee/oneof metadata, map
  last-wins mutation, map key/value metadata, map size/entry enumeration, map key lookup, repeated/map enum-name lookup, JSON-name field lookup/output, explicit default metadata, field presence/packing/reserved metadata,
