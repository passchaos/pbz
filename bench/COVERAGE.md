...
is `/tmp/pbz-compare-always-print-json-final.log` summarized by
`/tmp/pbz-summary-always-print-json-final.txt`. The fail-on-loss summary gate:

```sh
python3 bench/summarize_compare.py /tmp/pbz-compare-always-print-json-final.log --fail-on-loss
```
...
`bench/summarize_compare.py` currently tracks 404 workloads. The parsed baselines
include:
...
- simple JSON stringify/parse, including generated `map<string, int32>` surrogate-pair key parse, generated null-field parse, generated enum-name parse, generated always-print default-value stringify, generated proto-name stringify, generated proto-name parse, generated open-enum numeric parse, and generated integer numeric-exponent token parse
