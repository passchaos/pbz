...
- `examples/registry_loader.zig` covers public in-memory and filesystem schema
  ...
  and method lookup, reflection file/import/dependency metadata and import-chain lookup, registry-backed dynamic
...
- `examples/descriptors_codegen.zig` covers descriptor encode/decode,
  descriptor sets, source-code info lookup/accessors, uninterpreted custom options,
  service/method options including idempotency levels, direct codegen, plugin
  request generation, and generated-code info annotation lookup.
...
- `examples/proto2_extensions.zig` covers proto2 extension parsing, extension
  ...
  required-field validation, reflection extension/range/declaration/full-name/extendee/scope lookup, extension-range bounds/verification/declaration metadata and range/declaration enumeration, descriptor round-trips,
