...
- `examples/dynamic_editions_features.zig` covers dynamic protobuf editions
  ...
  relaxed UTF-8 strings, reflection file/message/field/oneof/enum/enum-value/service/method/extension-range feature metadata, cross-file extension owner-file feature defaults for dynamic/reflection paths, closed enum unknown preservation, and TextFormat
  round-trip.
