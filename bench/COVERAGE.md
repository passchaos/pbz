...
- `examples/dynamic_editions_features.zig` covers dynamic protobuf editions
  ...
  relaxed UTF-8 strings, reflection file/message/field/oneof/enum/enum-value/service/method/extension-range feature metadata and FeatureSet/FeatureSetDefaults accessors, cross-file extension owner-file feature defaults for dynamic binary/JSON/TextFormat/reflection paths, closed enum unknown preservation, and TextFormat
  round-trip.
...
- `examples/registry_loader.zig` covers public in-memory and filesystem schema
  ...
  and method lookup, reflection typed file option/import/dependency metadata, import-kind dependency index/option-dependency metadata and import-chain lookup/accessors/index, registry-backed dynamic
...
- `examples/dynamic_message.zig` covers dynamic runtime schema usage,
  repeated/map/oneof mutation, field, oneof presence, and map-entry query/clear helpers,
...
- `examples/descriptors_codegen.zig` covers descriptor encode/decode,
  descriptor sets, source-code info lookup/enumeration/accessors/path-span coordinate/index plus comment presence and detached-comment index, uninterpreted custom options,
...
- `examples/well_known_types.zig` covers selected well known types, including
  Timestamp, Duration, FieldMask emptiness/path presence/access/index, Empty JSON allocation helper, Struct emptiness/field presence/access/index/equality, Value equality/typed accessors, ListValue emptiness/presence/access/index/equality, scalar and
