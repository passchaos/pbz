...
- `examples/reflection_facade.zig` covers the public reflection facade over
  ...
  feature-support lifecycle metadata, ordered file/message/enum/service descriptor enumeration, file/message-local descriptor lookup, descriptor name/full-name/containing-type identity lookup,
