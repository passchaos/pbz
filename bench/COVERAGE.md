...
- `examples/well_known_types.zig` covers selected well known types, including
  Timestamp, Duration, FieldMask path presence/access/index, Empty, Struct field presence/access/index, Value equality/typed accessors, ListValue access/index, scalar and
