...
- `.proto` parser
  ...
  - messages, nested messages, groups, enums, oneofs, extensions, reserved ranges, field-number, reserved/extension/enum range, duplicate-field/oneof, oneof field-shape, and enum validation including allow_alias
...
- TextFormat support
  - dynamic message formatting/parsing for scalars, repeated fields, maps, enums, nested messages, `{}`/`<>` delimiters, common separators, and # comments
