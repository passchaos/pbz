...
- Protoc plugin and codegen helpers
  - basic CodeGeneratorRequest decode, CodeGeneratorResponse encode, and Zig typed scalar/repeated-scalar/enum skeleton generation
- TextFormat support
...
a starter Zig typed scalar/repeated-scalar/enum skeleton with field constants, fields, init, and encode methods for parsed descriptors.
