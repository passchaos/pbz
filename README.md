...
file/message/enum/enum-value/field/oneof/service/method uninterpreted options plus selected known options, including multi-part custom option names with extension name parts, decoded file syntax/edition/dependency metadata, file/message/field number/label/type-name,
