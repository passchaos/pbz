...
- `.proto` parser
  ...
  - messages, nested messages, groups, enums, oneofs, extensions, reserved ranges, field-number, reserved/extension/enum range conflicts, extension extendee/range/label/duplicate checks, duplicate-field/oneof/type-symbol, oneof field-shape, and enum validation including allow_alias
...
- TextFormat support
  - dynamic message formatting/parsing for scalars, repeated fields, maps, enums, nested messages, `{}`/`<>` delimiters with optional colon, bool aliases, common separators, # comments, and common string/bytes escapes
...
validation, and edition feature metadata.
