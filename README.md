...
default names on encode including registry-aware imported enum fields/defaults, typed scalar/enum default values on decode including unsigned 64-bit maxima,
