...
a starter Zig typed scalar/repeated-scalar/enum/message-payload/map skeleton with field constants, fields, init, encode, and basic decode methods for parsed descriptors.
