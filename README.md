...
a starter Zig typed scalar/repeated-scalar/enum/message-payload/map skeleton with field constants, fields, init, and encode methods for parsed descriptors.
