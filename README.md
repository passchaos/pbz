...
- Well-known types
  - basic google.protobuf.Timestamp, Duration, FieldMask, Any, Empty, Struct/Value/ListValue, and wrapper wire/JSON parse/stringify helpers with validation plus dynamic JSON mapping, including Timestamp timezone-offset parsing, wrapper null/default parsing, FieldMask path validation, and strict Empty object parsing
- Conformance helpers
