...
- `.proto` parser
  ...
  - basic SourceCodeInfo path/span generation for file-level syntax/package/import, top-level and nested message/enum/service declarations, fields, enum values, and RPC methods, including adjacent `//` leading comments and same-line trailing comments
...
structured SourceCodeInfo location path/span/comments including parser-generated basic declaration/field/enum-value/method locations and line comments, ExtensionRangeOptions
