...
- Dynamic message runtime
  ...
  - unknown field preservation/querying, extension encoding/decoding with Registry, registry-aware initialized encode/decode helpers, deterministic encoding including map key and unknown-field number/wire/raw ordering, and recursive message merging
- JSON support
