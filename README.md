...
- `.proto` parser
  ...
  - messages, nested messages, groups, enums, oneofs, extensions, reserved ranges, field-number, reserved/extension range, duplicate-field/oneof, oneof field-shape, and enum validation including allow_alias
